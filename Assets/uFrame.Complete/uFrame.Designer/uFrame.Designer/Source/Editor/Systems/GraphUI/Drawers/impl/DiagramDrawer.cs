...
namespace uFrame.Editor.GraphUI.Drawers
{
    ...
    public class DiagramDrawer : Drawer, IInputHandler
    {
        ...
        private void GraphItemsOnCollectionChangedWith(object sender, uFrame.Kernel.Collection.NotifyCollectionChangedEventArgs e)
        {
            GraphItemsOnCollectionChangedWith(e);
        }
        private void GraphItemsOnCollectionChangedWith(uFrame.Kernel.Collection.NotifyCollectionChangedEventArgs changeArgs)
        {
