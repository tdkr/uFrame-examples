...
namespace uFrame.MVVM.Bindings
{
    public class ModelCollectionBinding<TCollectionType> : Binding
    {
        ...
        private void BindNow()
        {
            CollectionOnChanged(this,
                new uFrame.Kernel.Collection.NotifyCollectionChangedEventArgs(uFrame.Kernel.Collection.NotifyCollectionChangedAction.Add,
                    Collection.Cast<object>().ToArray()));
        }

        private void CollectionOnChanged(object sender, uFrame.Kernel.Collection.NotifyCollectionChangedEventArgs changeArgs)
        {
    ...
    public class ModelViewModelCollectionBinding : Binding
    {
        ...
        public uFrame.Kernel.Collection.INotifyCollectionChanged Collection
        {
            get { return ModelProperty as uFrame.Kernel.Collection.INotifyCollectionChanged; }
        }
        ...
        public override void Bind()
        {
            ...
            {
                CollectionOnChanged(this, new uFrame.Kernel.Collection.NotifyCollectionChangedEventArgs(uFrame.Kernel.Collection.NotifyCollectionChangedAction.Add, List));
            }
        }
        ...
        private void CollectionOnChanged(object sender, uFrame.Kernel.Collection.NotifyCollectionChangedEventArgs changeArgs)
        {
            if (changeArgs.Action == uFrame.Kernel.Collection.NotifyCollectionChangedAction.Reset)
            {
