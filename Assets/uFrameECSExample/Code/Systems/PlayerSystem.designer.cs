...
namespace uFrameECSExample {
    ...
    public partial class PlayerSystemBase : uFrame.ECS.Systems.EcsSystem {
        ...
        private PlayerGunnerCreated PlayerGunnerCreatedInstance = new PlayerGunnerCreated();
        ...
        private PlayerSystemGameOverHandler PlayerSystemGameOverHandlerInstance = new PlayerSystemGameOverHandler();
        ...
        protected virtual void PlayerGunnerCreated(PlayerGunner data, PlayerGunner group) {
            var handler = PlayerGunnerCreatedInstance;
            handler.System = this;
            handler.Event = data;
            handler.Group = group;
            handler.Execute();
        ...
        protected virtual void PlayerSystemGameOverHandler(uFrameECSExample.GameOver data, WavesGame group) {
            var handler = PlayerSystemGameOverHandlerInstance;
            handler.System = this;
            handler.Event = data;
            handler.Group = group;
            handler.Execute();
